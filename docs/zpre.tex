...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=13,width=1.0\textwidth,trim={1cm 2cm 1cm 3cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=25,width=1.0\textwidth,trim={1cm 2cm 1cm 3cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=24,width=1.0\textwidth,trim={0.5cm 5cm 1cm 4.5cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=17,width=1.0\textwidth,trim={2cm 2cm 1cm 2cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=15,width=1.0\textwidth,trim={1cm 5cm 4cm 3cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=92,width=1.0\textwidth,trim={0.5cm 5cm 2cm 1cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=20,width=1.0\textwidth,trim={1cm 4cm 2cm 2cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=62,width=1.0\textwidth,trim={2cm 2cm 4cm 2cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=78,width=1.0\textwidth,trim={1cm 1cm 1cm 4cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=79,width=1.0\textwidth,trim={1cm 0cm 1cm 4cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=93,width=1.0\textwidth,trim={0cm 5cm 2cm 5.5cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=77,width=1.0\textwidth,trim={2cm 3cm 12cm 19cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=91,width=1.0\textwidth,trim={6cm 18cm 6cm 4cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=91,width=1.0\textwidth,trim={6cm 11cm 6cm 11cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=83,width=1.0\textwidth,trim={1cm 4cm 2cm 4.5cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=11,width=1.0\textwidth,trim={4.275cm 8.3cm 1cm 17cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=44,width=1.0\textwidth,trim={1cm 3cm 2cm 2cm},clip]{docs/zpre.pdf}}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[page=57,width=1.0\textwidth,trim={5cm 2cm 4.5cm 20.4cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=51,width=1.0\textwidth,trim={1cm 6cm 1cm 11cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=58,width=1.0\textwidth,trim={1cm 13cm 3cm 10cm},clip]{docs/zpre.pdf}}
...
\begin{table}[H]
  \centering
  \fbox{\includegraphics[page=59,width=1.0\textwidth,trim={3cm 6cm 2cm 10cm},clip]{docs/zpre.pdf}}
